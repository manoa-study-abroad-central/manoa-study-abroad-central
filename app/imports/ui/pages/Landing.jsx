...
const Landing = () => (
  <div id="landing-page">
    <Container fluid>
      <LandingNavBar />
      <Row>
        <Col xs={5} id="landing-description">
          <h1 style={{ fontSize: '60px' }}><strong>MANOA STUDY ABROAD CENTRAL</strong></h1>
      ...
      <Row>
        ...
        <a id="landing-title-join" href="/signup">JOIN NOW TO LEARN MORE!</a>
      </Row>
    </Container>
  </div>
);
